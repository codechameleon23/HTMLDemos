  ...
  return isBooth ? (
    <>
      ...
      <div className="pos-fixed pin-r pin-t-50 pin-t50 flex-col justify-end m-16">
        ...
        <button className="icon-button pos-relative my-4 p-8 bg-white hover:bg-primary f-color-primary hover:f-color-white rounded-full shadow-lg flex-row align-center cursor-pointer ml-auto">
