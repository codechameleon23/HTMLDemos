...
const WEBSITE_NAME = 'IS Accountancy';
const PROJECT_NAME = 'ISA-website-html';
const PROJECT_PATH = ".";
...
const PROJECT_JS_LIST = [
  ...
  // SRC_JS_PATH+'/_paceStart.js',
  SRC_JS_PATH+'/_docReady.js',
  // SRC_JS_PATH+'/_barba.js',
  // SRC_JS_PATH+'/_fittext.js',
  // SRC_JS_PATH+'/_textillate.js',
  ...
  SRC_JS_PATH+'/_multiLevelNavbar.js',
  ...
  SRC_JS_PATH+'/_customInputTypeFile.js',
...
const PROJECT_PAGES_LIST = [
  './src/all-pages.html',
  './src/index.html',
  './src/navigation-services.html',
  './src/accounting-services.html',
  './src/tax-services.html',
  './src/individuals-landlords.html',
  './src/find-us.html',
  './src/flexi-builder.html',
]
