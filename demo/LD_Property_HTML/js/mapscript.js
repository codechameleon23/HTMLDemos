...
if ($('#map-canvas').length){//if element exists
    function initialise() {
        ...
        var myLatlng = new google.maps.LatLng(50.852996, -1.174108); // Add the coordinates
        var mapOptions = {
            //styles: mapStyle,
        ...
        var infowindow = new google.maps.InfoWindow({ // Create a new InfoWindow
                content:"7 High Street Fareham, Hampshire, PO16 7AN" // HTML contents of the InfoWindow
            });
