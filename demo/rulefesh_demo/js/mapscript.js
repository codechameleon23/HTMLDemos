...
if ($('#map-canvas').length){//if element exists
    function initialise() {
        ...
        var address = 'Rule:fresh';

        var myLatlng = new google.maps.LatLng(50.816421, -0.517320); // Add the coordinates
        var mapOptions = {
            //styles: mapStyle,
        ...
        var image = new google.maps.MarkerImage("images/map-marker.png", null, null, null, new google.maps.Size(50,50)); // Create a variable for our marker image.
        ...
        var infowindow = new google.maps.InfoWindow({ // Create a new InfoWindow
                content: address // HTML contents of the InfoWindow
            });
