...
const WEBSITE_NAME = 'DBA Africa';
const PROJECT_NAME = 'DBA_Africa_Website_HTML';
const PROJECT_PATH = ".";
...
const PROJECT_PAGES_LIST = [
  './src/index.html',
  './src/who-we-are.html',
  './src/our-athletes.html',
  './src/athlete-profile.html',
  './src/stories.html',
  './src/story-details.html',
  './src/youth-academies.html',
  './src/get-involved.html',
  './src/contact.html',
